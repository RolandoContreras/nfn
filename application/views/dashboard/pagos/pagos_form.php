    ...
    <div class="row-fluid">
        <div class="widget_container">
            <div class="well">
              ...
              <input type="text" id="code" name="code" value="<?php echo isset($obj_pays->code)?$obj_pays->code:"";?>" class="input-xlarge-fluid" disabled="">
              <br><br>
              ...
              <div class="well nomargin" style="width: 200px;">
                  ...
                  <select name="active" id="active">
                         <option value="2" <?php if($obj_pays->active == 2){ echo "selected";}?>>Es espera de procesar</option>
                         <option value="3" <?php if($obj_pays->active == 3){ echo "selected";}?>>Pagado</option>
                         <option value="4" <?php if($obj_pays->active == 4){ echo "selected";}?>>Cancelado</option>
                  </select>
                  </div>
              </div>
