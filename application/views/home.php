          ...
          <div id="page-6" class="type-page">
            <div class="page-content entry-content">
              <div id="themify_builder_content-6" data-postid="6" class="themify_builder_content themify_builder_content-6 themify_builder">
                <div class="themify_builder_row module_row clearfix fullcover fullwidth_row_container module_row_0 themify_builder_6_row module_row_6-0">
                  <div class="row_inner col_align_middle">
                        ...
                        <div id="buttons-6-0-0-1" class="module module-buttons buttons-6-0-0-1  ">
                          <div class="module-buttons normal solid circle">
                            <div class="module-buttons-item  buttons-horizontal">
                                <a href="http://newfuturenetwork.com/software/backend" target="_blank" class="ui builder_button black"><span>REGISTRO</span></a> </div>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="module_column tb-column col3-2 last tb_6_column module_column_1 module_column_6-0-1">
                      <div class="tb-column-inner">
                        <!-- module image -->
                        <div id="image-6-0-1-0" class="module module-image image-6-0-1-0  image-center   wow fadeInUp">
                          <!--insert-->
                ...
                <!-- START ABOUTS -->
                <div data-anchor="about" class="themify_builder_row module_row clearfix fullcover fullwidth tb_section-about module_row_1 themify_builder_6_row module_row_6-1">
                                ...
                                <div id="feature-6-sub_row_4-0-2-0-2" class="module module-feature feature-6-sub_row_4-0-2-0-2 with-chart layout-icon-right size-small  ">
                                  <style type="text/css">
                                    #feature-6-sub_row_4-0-2-0-2 .module-feature-chart-html5 {
                                    				...
                                    				#feature-6-sub_row_4-0-2-0-2 .chart-loaded.chart-html5-fill {
                                    					box-shadow: inset 0 0 0 2px #405cc2;
                                    				}
                                  </style>
                                  <div class="module-feature-image">
                                ...
                                <div id="feature-6-sub_row_4-0-2-2-1" class="module module-feature feature-6-sub_row_4-0-2-2-1 with-chart layout-icon-left size-small  ">
                                  <style type="text/css">
                                    #feature-6-sub_row_4-0-2-2-1 .module-feature-chart-html5 {
                                    				...
                                    				#feature-6-sub_row_4-0-2-2-1 .chart-loaded.chart-html5-fill {
                                    					box-shadow: inset 0 0 0 2px #405cc2;
                                    				}
                                  </style>
                                  <div class="module-feature-image">
                                ...
                                <div id="feature-6-sub_row_4-0-2-2-2" class="module module-feature feature-6-sub_row_4-0-2-2-2 with-chart layout-icon-left size-small  ">
                                  <style type="text/css">
                                    #feature-6-sub_row_4-0-2-2-2 .module-feature-chart-html5 {
                                    				...
                                    				#feature-6-sub_row_4-0-2-2-2 .chart-loaded.chart-html5-fill {
                                    					box-shadow: inset 0 0 0 2px #405cc2;
                                    				}
                                  </style>
                                  <div class="module-feature-image">
