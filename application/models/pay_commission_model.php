...
class pay_commission_model_atributos{	
...
class Pay_commission_Model extends CI_Model{ 

    public function __construct() {
        parent::__construct();  
        $this->table = 'pay_commission';
	$this->table_id = 'pay_commission_id';
        $this->pay_commission_id='';
        $this->pay_id='';
        $this->commissions_id='';
	$this->status_value='';
        $this->created_at='';
        ...
        $this->updated_at='';
        $this->updated_by='';
	$this->fields = new pay_commission_model_atributos();
    }   
