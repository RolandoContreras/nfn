...
class customer_bank_model_atributos{	
    var $customer_bank_id='';
    var $customer_id='';
    var $titular='';
    var $bank_name='';
    var $account_number='';
    var $account_number_inter='';
    var $razon_social='';
    var $ruc='';
    var $address_ruc='';
    var $created_at='';
...
class Customer_bank_Model extends CI_Model{ 

    public function __construct() {
        parent::__construct();  
        $this->table = 'customer_bank';
	$this->table_id = 'customer_bank_id';
        $this->customer_bank_id='';
        $this->customer_id='';
        $this->titular='';
        $this->bank_name='';
        $this->account_number='';
        $this->account_number_inter='';
	$this->razon_social='';
        $this->ruc='';
        $this->address_ruc='';
        $this->created_at='';
        ...
        $this->updated_at='';
        $this->updated_by='';
	$this->fields = new customer_bank_model_atributos();
    }   
